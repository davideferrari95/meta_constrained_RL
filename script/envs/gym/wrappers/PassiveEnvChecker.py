...
class PassiveEnvChecker(gym.Wrapper):
    ...
    def __init__(self, env):
        """Initializes the wrapper with the environments, run the observation and action space tests."""
        super().__init__(env)
    ...
    def step(self, action: ActType, ratio:int=1, simulate_in_adamba:bool=False):
