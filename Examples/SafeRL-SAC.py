...
OpenAI - Safety Starter Agents - Safety-Gym

A companion repo to the paper "Benchmarking Safe Exploration in Deep Reinforcement Learning," 
containing a variety of unconstrained and constrained RL algorithms.

Safe-RL Soft Actor Critic
